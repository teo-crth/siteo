...
const footer = () => {
    return (
        <footer className='bg-gray-800 text-white text-center p-4'>
            <div className="container-footer w-full flex justify-center items-start font-title flex-wrap gap-4 relative">
                <div className="logo-container w-full md:w-[9%] lg:w-[10%] xl:w-[10%] flex flex-col justify-center items-center md:absolute lg:absolute xl:absolute left-3">
                    < LogoFooter />
                </div>
                <div className="links-container w-full md:max-w-[28%] lg:max-w-[28%] xl:max-w-[28%] flex flex-wrap justify-center gap-1">
                    ...
                    <div className="container-links flex flex-wrap md:flex-row lg:flex-row xl:flex-row md:gap-5 lg:gap-5 xl:gap-5 w-full justify-center gap-3">
                ...
                <div className="site-container w-full md:max-w-[28%] lg:max-w-[28%] xl:max-w-[28%] flex flex-wrap justify-center gap-1">
                    ...
                    <div className="container-links flex flex-col gap-0.5">
            ...
            <p className="font-title text-sm w-full text-center text-gray-400 mt-3">
