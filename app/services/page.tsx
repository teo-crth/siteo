    ...
    return (
        <div className='container-servicesPage flex flex-col items-center justify-start w-full p-8 pb-20 gap-5'>
            ...
            <div className="container-sections flex flex-col gap-5 w-full">
                <h2 className="font-title font-bold text-center text-4xl w-full">Création de site web</h2>
                <h3 className="font-title font-bold text-center text-2xl md:text-4xl w-full py-10">Choix du format le plus adapté à vos problèmatiques</h3>
                <section className="sites flex flex-wrap justify-center items-start gap-3">
                    <article className='section-surmesure flex justify-center items-start w-[97%] md:w-[70%] lg:w-[32%] xl:w-[32%]'>
                        <div className="card bg-white/15 shadow-[0_8px_32px_0_rgba(31,38,135,0.37)] backdrop-blur-lg border rounded-xl border-white/18 flex flex-col justify-start items-center gap-5 min-h-[300px]">
                            ...
                            <Link href='/faq/#pourquoi-choisir-un-site-internet-sur-mesure' className='text-center cursor-pointer text-blue-400 p-2 rounded-full w-full' aria-label="Naviguer vers la page Pourquoi choisir un site internet sur-mesure ?">
                    ...
                    <article className='section-wordpress flex justify-center items-start w-[97%] md:w-[70%] lg:w-[32%] xl:w-[32%]'>
                        <div className="card bg-white/15 shadow-[0_8px_32px_0_rgba(31,38,135,0.37)] backdrop-blur-lg border rounded-xl border-white/18 flex flex-col justify-start items-center gap-5 min-h-[300px]">
                            ...
                            <Link href='/faq/#pourquoi-choisir-un-site-wordpress-personnalise' className='text-center cursor-pointer text-blue-400 p-2 rounded-full w-full' aria-label="Naviguer vers la page Pourquoi choisir un site internet sur-mesure ?">
                    ...
                    <article className='section-vitrine flex justify-center items-start w-[97%] md:w-[70%] lg:w-[32%] xl:w-[32%]'>
                        <div className="card bg-white/15 shadow-[0_8px_32px_0_rgba(31,38,135,0.37)] backdrop-blur-lg border rounded-xl border-white/18 flex flex-col justify-start items-center gap-5 min-h-[300px]">
                            ...
                            <Link href='/faq/#pourquoi-choisir-un-site-vitrine' className='text-center cursor-pointer text-blue-400 p-2 rounded-full w-full' aria-label="Naviguer vers la page Pourquoi choisir un site internet sur-mesure ?">
                ...
                <section className="site-already-exist flex flex-wrap justify-center items-start gap-3">
                    ...
                    <article className='section-seo flex justify-center items-center w-[97%] md:w-[70%] lg:w-[48%] xl:w-[48%]'>
                        <div className="card bg-white/25 shadow-[0_8px_32px_0_rgba(31,38,135,0.37)] backdrop-blur-lg border rounded-xl border-white/18 flex flex-col justify-start items-center gap-4 min-h-[280px]">
                            ...
                            <Link href='/faq/#strategie-seo-cest-quoi' className='text-center cursor-pointer text-blue-400 p-2 rounded-full w-full' aria-label="Naviguer vers la page Pourquoi choisir un site internet sur-mesure ?">
