        ...
        <div className='container-servicesPage p-5'>
            ...
            <div className="container-sections flex flex-col gap-5 w-full p-5">
                ...
                <div className="sites flex flex-wrap justify-center items-start gap-3">
                    <section className='section-surmesure flex justify-center items-start p-5 w-[95%] md:w-[70%] lg:w-[32%] xl:w-[32%]'>
                        <div className="card bg-white/15 shadow-[0_8px_32px_0_rgba(31,38,135,0.37)] backdrop-blur-lg border rounded-4xl border-white/18 p-5 flex flex-col justify-start items-center gap-5 min-h-[300px]">
                            <h3 className='font-title font-bold text-center text-4xl'>Site internet sur-mesure</h3>
                            ...
                            <Link href='/faq/#pourquoi-choisir-un-site-internet-sur-mesure' className='text-center cursor-pointer text-blue-400 rounded-full w-full' aria-label="Naviguer vers la page Pourquoi choisir un site internet sur-mesure ?">
                                <p className='text-lg underline'>Pourquoi choisir un site internet sur-mesure ?</p>
                            </Link>
                        </div>
                    </section>
                    <section className='section-wordpress flex justify-center items-start p-5 w-[95%] md:w-[70%] lg:w-[32%] xl:w-[32%]'>
                        <div className="card bg-white/15 shadow-[0_8px_32px_0_rgba(31,38,135,0.37)] backdrop-blur-lg border rounded-4xl border-white/18 p-5 flex flex-col justify-start items-center gap-5 min-h-[300px]">
                            <h3 className='font-title font-bold text-center text-4xl'>Site internet Wordpress</h3>
                            <ul className='text-lg font-title font-bold tracking-wider text-light text-justify flex justify-center items-center flex-wrap gap-1'>
                            ...
                            <Link href='/faq/#pourquoi-choisir-un-site-wordpress-personnalise' className='text-center cursor-pointer text-blue-400 rounded-full w-full' aria-label="Naviguer vers la page Pourquoi choisir un site internet sur-mesure ?">
                                <p className='text-lg underline'>Pourquoi choisir un site WordPress personnalisé ?</p>
                            </Link>
                        </div>
                    </section>
                    <section className='section-vitrine flex justify-center items-start p-5 w-[95%] md:w-[70%] lg:w-[32%] xl:w-[32%]'>
                        <div className="card bg-white/15 shadow-[0_8px_32px_0_rgba(31,38,135,0.37)] backdrop-blur-lg border rounded-4xl border-white/18 p-5 flex flex-col justify-start items-center gap-5 min-h-[300px]">
                            <h3 className='font-title font-bold text-center text-4xl'>Site vitrine</h3>
                            <ul className='text-lg font-title font-bold tracking-wider text-light text-justify flex justify-center items-center flex-wrap gap-1'>
                            ...
                            <Link href='/faq/#pourquoi-choisir-un-site-vitrine' className='text-center cursor-pointer text-blue-400 rounded-full w-full' aria-label="Naviguer vers la page Pourquoi choisir un site internet sur-mesure ?">
                                <p className='text-lg underline'>Pourquoi choisir un site vitrine ?</p>
                            </Link>
                        </div>
                    </section>
                </div>
                <h2 className="font-title font-bold text-center text-4xl w-full p-10">Services complémentaires pour un site existant</h2>
                <div className="site-already-exist flex flex-wrap justify-center items-start gap-3">
                    <section className='section-modification flex justify-center items-center p-5 w-[95%] md:w-[70%] lg:w-[48%] xl:w-[48%]'>
                        <div className="card bg-white/25 shadow-[0_8px_32px_0_rgba(31,38,135,0.37)] backdrop-blur-lg border rounded-4xl border-white/18 p-5 flex flex-col justify-start items-center gap-4 min-h-[280px]">
                            <h3 className='font-title font-bold text-center text-4xl'>Modification de site internet</h3>
                            <ul className='text-lg font-title font-bold tracking-wider text-light text-justify flex justify-center items-center flex-wrap gap-1'>
                    ...
                    <section className='section-seo flex justify-center items-center p-5 w-[95%] md:w-[70%] lg:w-[48%] xl:w-[48%]'>
                        <div className="card bg-white/25 shadow-[0_8px_32px_0_rgba(31,38,135,0.37)] backdrop-blur-lg border rounded-4xl border-white/18 p-5 flex flex-col justify-start items-center gap-4 min-h-[280px]">
                            <h3 className='font-title font-bold text-center text-4xl'>Référencement naturel (SEO)</h3>
                            <ul className='text-lg font-title font-bold tracking-wider text-light text-justify flex justify-center items-center flex-wrap gap-1'>
                            ...
                            <Link href='/faq/#strategie-seo-cest-quoi' className='text-center cursor-pointer text-blue-400 rounded-full w-full' aria-label="Naviguer vers la page Pourquoi choisir un site internet sur-mesure ?">
                ...
                <section className='section-maintenance flex justify-center items-center p-5 w-full'>
                    <div className="card bg-white/25 shadow-[0_8px_32px_0_rgba(31,38,135,0.37)] backdrop-blur-lg border rounded-4xl border-white/18 p-5 w-[95%] md:w-[70%] lg:w-[50%] xl:w-[50%] flex flex-col justify-center items-center gap-2">
